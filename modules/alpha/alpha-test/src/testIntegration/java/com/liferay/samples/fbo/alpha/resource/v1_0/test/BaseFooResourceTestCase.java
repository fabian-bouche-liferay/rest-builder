...
import com.liferay.samples.fbo.alpha.client.dto.v1_0.Foo;
import com.liferay.samples.fbo.alpha.client.http.HttpInvoker;
import com.liferay.samples.fbo.alpha.client.pagination.Page;
import com.liferay.samples.fbo.alpha.client.resource.v1_0.FooResource;
import com.liferay.samples.fbo.alpha.client.serdes.v1_0.FooSerDes;
...
public abstract class BaseFooResourceTestCase {
	...
	public void testGetFooPage() throws Exception {
		Page<Foo> page = fooResource.getFooPage();

		long totalCount = page.getTotalCount();

		Foo foo1 = testGetFooPage_addFoo(randomFoo());

		Foo foo2 = testGetFooPage_addFoo(randomFoo());

		page = fooResource.getFooPage();
		...
		fooResource.deleteFoo(foo1.getId());

		fooResource.deleteFoo(foo2.getId());
	}

	protected Foo testGetFooPage_addFoo(Foo foo) throws Exception {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.liferay.samples.fbo.alpha.dto.v1_0.Foo.class)) {
	...
	@Inject
	private com.liferay.samples.fbo.alpha.resource.v1_0.FooResource
		_fooResource;
