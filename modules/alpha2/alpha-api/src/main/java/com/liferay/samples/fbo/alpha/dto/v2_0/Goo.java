package com.liferay.samples.fbo.alpha.dto.v2_0;
...
@XmlRootElement(name = "Goo")
public class Goo implements Serializable {

	public static Goo toDTO(String json) {
		return ObjectMapperUtil.readValue(Goo.class, json);
	}

	public static Goo unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Goo.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.samples.fbo.alpha.dto.v2_0.Goo",
		name = "x-class-name"
	)
